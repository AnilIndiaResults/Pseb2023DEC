            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        string body = "<table width = " + 600 + " cellpadding=" + 4 + " cellspacing=" + 4 + " border=" + 0 + "><tr><td colspan = " + 2 + " ><b> Dear " + name + " ji</b>,</td></tr><tr><td height = " + 30 + " colspan=" + 2 + ">As per your request Dated<b>" + DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "</b> <br/><br/> </td></tr><tr><td colspan = " + 2 + " ><b> Your Centre Code And Centre name are given Below:-</b><br /></td></tr><table border=" + 1 + "><tr><td>Center Code</td> <td>Center Name</td> <td>Remarks</td></tr><tr><td>" + strCent + "</td><td>" + strCentName + "</td><td>" + Remarks + "</td></tr></table><tr><td height = " + 30 + " colspan= " + 2 + " ><b> Click Here To Login</b> <a href = https://www.registration.pseb.ac.in/DeoPortal target = _blank>www.registration.pseb.ac.in</a></td></tr><tr><td colspan=" + 2 + "><b>Note:</b> Please Read Instruction Carefully Before filling the Online Form .</td></tr><tr><td colspan=" + 2 + ">This is a system generated e-mail and please do not reply. Add <a target=_blank href=mailto:noreply@psebonline.in>noreply@psebonline.in</a> to your white list / safe sender list. Else, your mailbox filter or ISP (Internet Service Provider) may stop you from receiving e-mails.</td></tr><tr><td colspan=" + 2 + "><b><i>Regards</b><i>,<br /> Tech Team, <br />Punjab School Education Board<br /></td></tr></table>";
                        //string body = "<table width = " + 600 + " cellpadding=" + 4 + " cellspacing=" + 4 + " border=" + 0 + "><tr><td colspan = " + 2 + " ><b> Dear " + name + " ji</b>,</td></tr><tr><td height = " + 30 + " colspan=" + 2 + ">As per your request Dated<b>" + DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "</b> <br/><br/> </td></tr><tr><td colspan = " + 2 + " ><b> Your Centre Code And Centre name are given Below:-</b><br /></td></tr><table border=" + 1 + "><tr><td>Center Code</td> <td>Center Name</td> <td>Remarks</td></tr><tr>" + strCent + "" + strCentName + "" + Remarks + "</tr></table><tr><td height = " + 30 + " colspan= " + 2 + " ><b> Click Here To Login</b> <a href = https://www.registration.pseb.ac.in/DeoPortal target = _blank>www.registration.pseb.ac.in</a></td></tr><tr><td colspan=" + 2 + "><b>Note:</b> Please Read Instruction Carefully Before filling the Online Form .</td></tr><tr><td colspan=" + 2 + ">This is a system generated e-mail and please do not reply. Add <a target=_blank href=mailto:noreply@psebonline.in>noreply@psebonline.in</a> to your white list / safe sender list. Else, your mailbox filter or ISP (Internet Service Provider) may stop you from receiving e-mails.</td></tr><tr><td colspan=" + 2 + "><b><i>Regards</b><i>,<br /> Tech Team, <br />Punjab School Education Board<br /></td></tr></table>"; 
                        // string body = "<table width = " + 600 + " cellpadding=" + 4 + " cellspacing=" + 4 + " border=" + 0 + "><tr><td colspan = " + 2 + " ><b> Dear " + name + " ji</b>,</td></tr><tr><td height = " + 30 + " colspan=" + 2 + ">As per your request Dated<b>" + DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "</b> <br/><br/><b>" + Remarks + "</b> </td></tr><tr><td colspan = " + 2 + " ><b> Your Centre Code And Centre name are given Below:-</b><br /></td></tr><tr><td>Center Code</td> <td>Center Name</td></tr><tr><td>" + strCent + "</td><td>"+strCentName+"</td></tr><tr><td height = " + 30 + " colspan= "+2+" ><b> Click Here To Login</b> <a href = https://www.registration.pseb.ac.in/DeoPortal target = _blank>www.registration.pseb.ac.in</a></td></tr><tr><td colspan=" + 2 + "><b>Note:</b> Please Read Instruction Carefully Before filling the Online Form .</td></tr><tr><td colspan=" + 2 + ">This is a system generated e-mail and please do not reply. Add <a target=_blank href=mailto:noreply@psebonline.in>noreply@psebonline.in</a> to your white list / safe sender list. Else, your mailbox filter or ISP (Internet Service Provider) may stop you from receiving e-mails.</td></tr><tr><td colspan=" + 2 + "><b><i>Regards</b><i>,<br /> Tech Team, <br />Punjab School Education Board<br /></td></tr></table>";
                        // string body = "<table width=" + 600 + " cellpadding=" + 4 + " cellspacing=" + 4 + " border=" + 0 + "><tr><td><b>Dear " + name + " ji</b>,</td></tr><tr><td height=" + 30 + ">As per your request Dated <b>" + DateTime.Now.ToString("dd-MM-yyyy HH:mm:ss") + "</b> <br/><br/><b>" + Remarks + "</b> </td></tr><tr><td><b>Your Centre Code And Centre name are given Below:-</b><br /><br />" + strtable + "<br /></td></tr><tr><td height=" + 30 + "><b>Click Here To Login</b> <a href=https://www.registration.pseb.ac.in/DeoPortal target = _blank>www.registration.pseb.ac.in</a></td></tr><tr><td><b>Note:</b> Please Read Instruction Carefully Before filling the Online Form .</td></tr><tr><td>This is a system generated e-mail and please do not reply. Add <a target=_blank href=mailto:noreply@psebonline.in>noreply@psebonline.in</a> to your white list / safe sender list. Else, your mailbox filter or ISP (Internet Service Provider) may stop you from receiving e-mails.</td></tr><tr><td><b><i>Regards</b><i>,<br /> Tech Team, <br />Punjab School Education Board<br />";
