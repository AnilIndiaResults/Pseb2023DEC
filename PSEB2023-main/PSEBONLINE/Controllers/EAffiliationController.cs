...
namespace PSEBONLINE.Controllers
{
    ...
    public class EAffiliationController : Controller
    {
            ...
            else
            {
                ...
                if (result > 0)
                {
                    ...
                    if (ol.APPNO == outError)
                    {
                        ...
                        try
                        {
                            string Sms = "You are successfully registered under E-Affiliation. Your App. No: " + ol.APPNO + " and Pwd: " + ol.PWD + ".Kindly Login & complete your form";
            ...
            else
            {
                ...
                else if (act == "U") // for update
                {
                    ...
                    else
                    {
                        ...
                        {
                            @ViewBag.STAFFFILE = "../../Upload/" + easdm.StaffFile.ToString();
                        }
            ...
            if (!string.IsNullOrEmpty(cmd))
            {
                ...
                if (cmd.ToLower() == "submit" || cmd.ToLower() == "save" || cmd.ToLower() == "update")
                {
                    ...
                    if (StaffFile != null)
                    {
                        ...
                        easdm.StaffFile = "Upload2023/EAffiliation2021/STAFFFILE/" + StaffFileName;
                    }
        ...
        public JsonResult GetGroupByClass(string SelClass)
        {
            ...
            if (SelClass == "12")
            {
                string search = "appno='" + Session["eAffiliationAppNo"].ToString() + "' and class='" + SelClass + "'  ";
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(cmd))
                {
                    ...
                    if (docfile != null)
                    {
                        ...
                        //eadm.DocFile = "Upload2023/EAffiliation2021/UploadEAffiliationDocuments/" + filename;
                        path = Path.Combine(Server.MapPath("allfiles/Upload2023/EAffiliation2021/UploadEAffiliationDocuments"), filename);
                        FilepathExist = Path.Combine(Server.MapPath("allfiles/Upload2023/EAffiliation2021/UploadEAffiliationDocuments"));
                            ...
                            using (var client = new AmazonS3Client(ConfigurationManager.AppSettings["AWSKey"], ConfigurationManager.AppSettings["AWSValue"], RegionEndpoint.APSouth1))
                            {
                                using (var newMemoryStream = new MemoryStream())
                                {
                                    ...
                                    var uploadRequest = new TransferUtilityUploadRequest
                                    {
                                        ...
                                        Key = string.Format("allfiles/Upload2023/EAffiliation2021/UploadEAffiliationDocuments/{0}", filename),
