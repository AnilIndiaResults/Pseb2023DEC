...
namespace PSEBONLINE.Models
{
    ...
    public class PrivateCandidateCategoryMasters
    {
        [Key]
        public int Id { get; set; }
        public string PrivateCandidateCategoryABBR { get; set; }
        public string PrivateCandidateCategoryName { get; set; }
    ...
    public class PrivateCandidateModels
    {
        public Byte[] QRCode { get; set; }
        public int DisabilityPercent { get; internal set; }
        public string AdminId { get; internal set; }
        public string EmpUserId { get; internal set; }
        public string IsHardCopyCertificate { get; internal set; }

        public string EXAMROLL { get; internal set; }
        ...
        public string tehsilEC { get; internal set; }
        public string tehsilEC2 { get; internal set; }
        ...
        public string NROLL { get; internal set; }
        ...
        public string OsetNo { get; internal set; }        
    ...
    public class PrivateFeeHomeViewModel
    {
        public DataSet StoreAllData { get; set; }
        public int ID { get; set; }
    ...
    public class PrivatePaymentformViewModel
    {
        ...
        public int TotalFees { get; set; }
        public int TotalCertFees { get; set; }
    ...
    public class PrivateChallanMasterModel
    {
        public string EmpUserId { get; internal set; }
        public string category { get; internal set; }
        public string roll { get; internal set; }
