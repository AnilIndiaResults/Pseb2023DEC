...
namespace PSEBONLINE.Models
{
    public class PunAddModels
    {
        ...
        public string EligibilityDoc1 { get; internal set; }
        public string EligibilityDoc2 { get; internal set; }
        //
        public string CList { get; internal set; }
    ...
    public class PunAddFeeHomeViewModel
    {
        public DataSet StoreAllData { get; set; }
        public int ID { get; set; }
    ...
    public class PunAddPaymentformViewModel
    {
        public int TotalCertFees { get; set; }
        //public string batch { get; internal set; }
        //public string batchyear { get; internal set; }
        public string AllowBank { get; internal set; }
    ...
    public class PunAddChallanMasterModel
    {
        //public string batch { get; internal set; }
        //public string batchyear { get; internal set; }
        public string EmpUserId { get; internal set; }
