    ...
    public class ImportDataController : Controller
    {
        ...
        public ActionResult ImportDataN3Class(int? page)
        {
            try
            {
                ...
                var itemsch = new SelectList(new[] {  new { ID = "3", Name = "Registration Number" },
                    new { ID = "7", Name = "Aadhar Number" },new { ID = "8", Name = "TC Refno No." },
                    new { ID = "4", Name = "OLD ID" }}, "ID", "Name", 1);
                ViewBag.MySch = itemsch.ToList();
        ...
        public ActionResult ImportData10thClass(int? page)
        {
            try
            {
                ...
                ViewBag.MySch = itemsch.ToList();
                var sessionsrcs = new SelectList(new[] { new { ID = "Self", Name = "Self School" }, new { ID = "Other", Name = "Other School" } }, "ID", "Name", 1);
                ViewBag.MySessions = sessionsrcs.ToList();
        ...
        public ActionResult ImportData10thpassedAnySchool(int? page)
        {
            try
            {
                ...
                var sessionsrc = AbstractLayer.ImportDB.GetImportSessionLast3NewReAppear();
                ViewBag.MySession = sessionsrc.ToList();
        ...
        public ActionResult ImportData11THFailedSelfSchl(int? page)
        {
            try
            {
                ...
                //new { ID = "1", Name = "ALL" }, new { ID = "2", Name = "Candidate Name" },
                var itemsch = new SelectList(new[] {  new { ID = "3", Name = "Registration Number" }, new { ID = "7", Name = "Aadhar Number" }, new { ID = "4", Name = "OLD Student ID" }, new { ID = "5", Name = "Old Roll" }, }, "ID", "Name", 1);
                ViewBag.MySch = itemsch.ToList();
        ...
        public ActionResult ImportData11THFailedSelfSchl(int? page, Import imp, FormCollection frm, string cmd, string SelList, string SearchString, string Session1, string chkImportid)
        {
            try
            {
                ...
                //new { ID = "1", Name = "ALL" }, new { ID = "2", Name = "Candidate Name" }, 
                var itemsch = new SelectList(new[] { new { ID = "1", Name = "ALL" }, new { ID = "2", Name = "Candidate Name" }, new { ID = "3", Name = "Registration Number" }, new { ID = "7", Name = "Aadhar Number" }, new { ID = "4", Name = "OLD Student ID" }, new { ID = "5", Name = "Old Roll" }, }, "ID", "Name", 1);
                ViewBag.MySch = itemsch.ToList();
                ...
                if (cmd == "Search")
                {
                    Search = "1=1 ";// "schl ='" + imp.schoolcode + "' and class=3 ";
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        if (rm.file != null)
                        {
                            var path = Path.Combine(Server.MapPath("~/Upload/" + formName + "/" + Session["Dist"].ToString() + "/Photo"), result + "P" + ".jpg");
                            string FilepathExist = Path.Combine(Server.MapPath("~/Upload/" + formName + "/" + Session["Dist"].ToString() + "/Photo"));
                        ...
                        if (rm.std_Sign != null)
                        {
                            ...
                            filepathtosave = "../Upload/" + formName + "/" + Session["Dist"].ToString() + "/Sign/" + result + "S" + ".jpg";
                            ViewBag.ImageURL = filepathtosave;
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        if (rm.file != null)
                        {
                            ...
                            rm.file.SaveAs(path);
                            filepathtosave = "../Upload/" + formName + "/" + distOld + "/Photo/" + result + "P" + ".jpg";
                            ViewBag.ImageURL = filepathtosave;
        ...
        public ActionResult Import9thPass(int? page)
        {
            try
            {
                ...
                var itemsch = new SelectList(new[] {  new { ID = "3", Name = "Registration Number" },
                    new { ID = "7", Name = "Aadhar Number" },new { ID = "8", Name = "TC Refno No." },
                    new { ID = "4", Name = "OLD Student ID" }, new { ID = "5", Name = "Old Roll" }, }, "ID", "Name", 1);
                ViewBag.MySch = itemsch.ToList();
