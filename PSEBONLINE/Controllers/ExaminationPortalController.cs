...
namespace PSEBONLINE.Controllers
{
    public class ExaminationPortalController : Controller
    {
        ...
        {
            string IsWantselfcenter = storescid;
            storescid = storeid;
            ...
            dee = objDB.insertinbulkexammasterregular2017(storeid, storescid, storeaashirwardno, IsWantselfcenter);
        ...
        public ActionResult DownloadExamFinalReport(string ChallanId, string Filename)
        {
            try
            {
                ...
                if (OutStatus == 1)
                {
                    return File("testreg2023.pseb.ac.in/" + Filename, "application/pdf");
                }
                else
                {
